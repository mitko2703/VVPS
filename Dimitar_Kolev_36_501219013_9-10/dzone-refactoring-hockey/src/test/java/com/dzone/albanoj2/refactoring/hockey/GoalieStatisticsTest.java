...
public class GoalieStatisticsTest {
	...
	@Test
	public void myTest1() {
		season.addGame(new Game(8, 15, 50 ));
		GoalieStatistics statistics = season.getGoalieStatistics();
		assertEquals(0.4667, round4Decimals(statistics.getSavePercentage()), TOLERANCE);
	}

	@Test
	public void myTest2() {
		season.addGame(new Game(2, 6, 30 ));
		season.addGame(new Game(5, 18, 60 ));
		season.addGame(new Game(6, 15, 40 ));
		GoalieStatistics statistics = season.getGoalieStatistics();
		assertEquals(0.6667, round4Decimals(statistics.getSavePercentage()), TOLERANCE);
	}
}
